         ...
         <!-----------------------------------------------------------------------  -->
            ...
            <!-- Card  Button Homme Femme Enfant - Taille - Couleur -->
                ...
                <div class="card  action_card col-md-2 col-sm-2 mr-1">
                    <img class="card-img-top mt-3" src="<?php echo e(asset('img/short.png')); ?>" alt="Short Long Surf">
                    <div class="card-body">
                ...
                <!-- Card Tee Shirt -->
                <div class="card action_card col-md-2 col-sm-2 mr-1" >
                <img class="card-img-top mt-3" src="<?php echo e(asset('img/tee-shirt.png')); ?>" alt="tee-shirt Hossegor">
                    <div class="card-body">
                ...
                <!-- Card Casquette -->
                 <div class="card action_card col-md-2 col-sm-2 mr-1" >
                <img class="card-img-top mt-3" src="<?php echo e(asset('img/casquette.png')); ?>" alt="Casquette Surf">
                    <div class="card-body">
                ...
                <!-- Card Veste -->
                 <div class="card action_card col-md-2 col-sm-2 mr-1" >
                <img class="card-img-top mt-3" src="<?php echo e(asset('img//veste.png')); ?>" alt="Veste Surf">
                    <div class="card-body">
